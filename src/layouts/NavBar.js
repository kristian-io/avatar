...
export default function NavBar() {
    ...
    return (
        <nav className="flex items-center text-xl justify-between flex-wrap bg-slate-950  p-6">
            <div className="flex-shrink-0 text-white mr-6">
                <Link to="/" className="flex items-center gap-2">
                    ...
                    <img
                        ...
                        alt="SaaS logo"
                    />
                    <span className="text-center">AI Photo Editor</span>
                </Link>
            </div>
            ...
            <div className="block lg:hidden ">
                <button
                    onClick={toggleMenu}
                    className="flex items-center px-3 py-2 border rounded text-zinc-100 border-zink-100 hover:text-white hover:border-white"
                >
                    <svg
            ...
            <div
                id="menu"
                className={`${menuVisible} block w-full md:flex-grow lg:flex lg:items-center lg:w-auto ml-4`}
            >
                    ...
                    {isAuthenticated() && (
                        <>
                            <Link to={"/dashboard"}>
                                <button
                                    onClick={toggleMenu}
                                    className="inline-block text-sm p-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-zinc-500 hover:bg-white lg:mt-0"
                                >
                                    Dashboard
                                </button>
                            </Link>
