        ...
        <div className="bg-slate-950">
            <form onSubmit={handleSubmit}>
                <div className="m-4  p-2 lg:p-6 border border-slate-800 bg-slate-900 rounded justify-center large:w-3/5 small:w-full">
                    <h1 className="flex justify-center text-center my-8  text-xl">
                        Upload your Photos to create a new Gallery
                    </h1>
                    <div className="flex justify-center">
                        ...
                        <input
                            className="appearance-none large:w-3/5 small:w-full block text-lg text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                            ref={ref}
                            type="file"
                            required
                            multiple
                    ...
                    <div className="flex justify-center">
                        <div className="">
                            <button
                                ...
                                className="flex items-center gap-2 mx-4 my-4 px-3 py-1 border rounded border-slate-600 hover:border-slate-400 hover:shadow transition duration-250"
                                type="submit"
                            >
